...
router.get('/', async (req, res) => {
    try {
        ...
        return res.status(400).json({ error: 'Error loading preojects' })
    }
});
...
router.get('/:projectId', async (req, res) => {
    ...
    try {
        ...
        return res.status(400).json({ error: 'Error loading preoject' })
    }
});
...
router.delete('/:projectId', async (req, res) => {
    try {
        ...
        return res.status(400).json({ error: 'Error deleting preoject' })
    }
});
